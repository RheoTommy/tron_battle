use crate::game::Operation::{Down, Left, Right, Up};
use crate::game::Piece::{Empty, Player};
use crate::serve::{Point, Request};
...
impl Board {
    ...
    pub(crate) fn min_max(&self, depth: usize) -> Operation {
        self.enumerate()
            .into_par_iter()
            .max_by_key(|op| {
